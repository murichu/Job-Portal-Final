  ...
  try {
    ...
    const [applications, total] = await Promise.all([
      JobApplication.find({ userId })
        ...
        .populate("jobId", "title description location category level deadline salary salaryMode salaryAmount salaryMin salaryMax salaryVisible isNegotiable jobStatus approvalStatus")
        .sort({ createdAt: -1 })
        .skip(skip)
        .limit(limit)
        .lean(),
